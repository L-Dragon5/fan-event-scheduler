...
class AuthenticatedMain extends Component {
  ...
  render() {
    const routeComponents = this.routes.map(({ path, render }, key) => (
      ...
      <HashRouter>
        <ul id="sidebar" className="sidenav sidenav-fixed">
            ...
            <div className="user-view">
              ...
              <div>
                ...
                {this.state && this.state.socialWeb && (
                  <ExternalLink
                    className="right external-link__icon"
                    href={this.state.socialWeb}
                  >
          ...
          {this.state && this.state.registrationLink && (
            <li>
              <ExternalLink
                href={this.state.registrationLink}
          ...
          {this.state && !this.state.token && (
            <button
              ...
              style={{ position: 'absolute', bottom: '11vh', left: '36%' }}
            >
              Log in
            </button>
          )}
